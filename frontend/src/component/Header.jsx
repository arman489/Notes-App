        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="relative md:hidden">
              ...
              {open && (
                <div className="absolute right-0 mt-2 bg-white rounded-lg shadow-lg w-36 overflow-hidden">
                  <button
                    onClick={handleLogout}
                    className="w-full px-4 py-3 text-left hover:bg-red-100 hover:text-red-600"
                  >
                    Logout
                  </button>
                </div>
          ...
          <div className="hidden md:flex items-center gap-4 relative">
            ...
            {open && (
              <div className="absolute right-0 top-14 bg-white rounded-lg shadow-xl w-40 overflow-hidden">
                <button
                  onClick={handleLogout}
